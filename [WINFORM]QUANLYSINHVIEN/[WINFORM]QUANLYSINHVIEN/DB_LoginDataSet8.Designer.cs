...
namespace _WINFORM_QUANLYSINHVIEN {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("DB_LoginDataSet8")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class DB_LoginDataSet8 : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected DB_LoginDataSet8(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            DB_LoginDataSet8 cln = ((DB_LoginDataSet8)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "DB_LoginDataSet8";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DB_LoginDataSet8.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            DB_LoginDataSet8 ds = new DB_LoginDataSet8();
        ...
        public partial class hocsinhDataTable : global::System.Data.TypedTableBase<hocsinhRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public hocsinhRow AddhocsinhRow(int Id, string FName, string LName) {
        ...
        public partial class scoreDataTable : global::System.Data.TypedTableBase<scoreRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public scoreRow AddscoreRow(int student_id, int course_id, double student_score) {
...
namespace _WINFORM_QUANLYSINHVIEN.DB_LoginDataSet8TableAdapters {
    ...
    public partial class hocsinhTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[hocsinh] WHERE (([Id] = @Original_Id) AND ((@IsNull_FName = 1 " +
                "AND [FName] IS NULL) OR ([FName] = @Original_FName)) AND ((@IsNull_LName = 1 AND" +
                " [LName] IS NULL) OR ([LName] = @Original_LName)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[hocsinh] ([Id], [FName], [LName]) VALUES (@Id, @FName, @LName)" +
                ";\r\nSELECT Id, FName, LName FROM hocsinh WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[hocsinh] SET [Id] = @Id, [FName] = @FName, [LName] = @LName WHERE (([Id] = @Original_Id) AND ((@IsNull_FName = 1 AND [FName] IS NULL) OR ([FName] = @Original_FName)) AND ((@IsNull_LName = 1 AND [LName] IS NULL) OR ([LName] = @Original_LName)));
SELECT Id, FName, LName FROM hocsinh WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FName, LName FROM dbo.hocsinh";
        ...
        public virtual int Fill(DB_LoginDataSet8.hocsinhDataTable dataTable) {
        ...
        public virtual DB_LoginDataSet8.hocsinhDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DB_LoginDataSet8.hocsinhDataTable dataTable = new DB_LoginDataSet8.hocsinhDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB_LoginDataSet8.hocsinhDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB_LoginDataSet8 dataSet) {
    ...
    public partial class scoreTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[score] ([student_id], [course_id], [student_score]) VALUES (@s" +
                "tudent_id, @course_id, @student_score);\r\nSELECT student_id, course_id, student_s" +
                "core FROM score WHERE (student_id = @student_id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[score] SET [student_id] = @student_id, [course_id] = @course_id, [student_score] = @student_score WHERE (([student_id] = @Original_student_id) AND ((@IsNull_course_id = 1 AND [course_id] IS NULL) OR ([course_id] = @Original_course_id)) AND ((@IsNull_student_score = 1 AND [student_score] IS NULL) OR ([student_score] = @Original_student_score)));
SELECT student_id, course_id, student_score FROM score WHERE (student_id = @student_id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT student_id, course_id, student_score FROM dbo.score";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DB_LoginDataSet8.scoreDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DB_LoginDataSet8.scoreDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DB_LoginDataSet8.scoreDataTable dataTable = new DB_LoginDataSet8.scoreDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB_LoginDataSet8.scoreDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int student_id, global::System.Nullable<int> course_id, global::System.Nullable<double> student_score) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int student_id, global::System.Nullable<int> course_id, global::System.Nullable<double> student_score, int Original_student_id, global::System.Nullable<int> Original_course_id, global::System.Nullable<double> Original_student_score) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> course_id, global::System.Nullable<double> student_score, int Original_student_id, global::System.Nullable<int> Original_course_id, global::System.Nullable<double> Original_student_score) {
            return this.Update(Original_student_id, course_id, student_score, Original_student_id, Original_course_id, Original_student_score);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(DB_LoginDataSet8 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._hocsinhTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(DB_LoginDataSet8 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._hocsinhTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(DB_LoginDataSet8 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._scoreTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(DB_LoginDataSet8 dataSet) {
            if ((dataSet == null)) {
